...
// 🔹 4️⃣ Donation API Permissions
                                ...
                                .requestMatchers("/donations/{id}/send-otp").hasAnyAuthority("ROLE_NGO", "ROLE_ADMIN","ROLE_DONOR")
                                .requestMatchers("/donations/{id}/complete").hasAnyAuthority("ROLE_NGO", "ROLE_ADMIN","ROLE_DONOR")  // ✅ Complete donation
